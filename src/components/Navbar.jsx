...
import { mainBody, repos, about, skills, notionSite } from '../editable-stuff/config.js';
    ...
    <Navbar ref={navbarMenuRef} className={` fixed-top  ${!isTop ? 'navbar-white' : 'navbar-transparent'}`} expand='lg'>
      ...
      <Navbar.Collapse id='basic-navbar-nav'>
        <Nav className='mr-auto'>
          ...
          <Nav.Link className='nav-link lead' href={notionSite}>
            <stong style={{ fontWeight: 'bold' }}>Notion</stong>
          </Nav.Link>
          {skills.show && (
          ...
          <Nav.Link className='nav-link lead' href={process.env.PUBLIC_URL + '/#contact'}>
            Contact
          </Nav.Link>
        </Nav>
      </Navbar.Collapse>
