...
const projects = {
  ...
  projects: [
    {
      name: 'Life With Book',
      message: '서점 베스트셀러 및 공공도서관 실시간 대출 인기 도서 및 검색 (공사중 🔨)',
      alt: 'lifeWithBook',
      imageLink: require('./projects/life-with-book.png'),
      git: 'https://github.com/ivanselah/life-with-book',
      deploy: 'https://ivanselah.github.io/life-with-book',
      languages: 'React, PostCSS, FireBase(Login)',
    },
    {
      name: 'Home Browser',
      message: '지인(선생님)들의 기존의 불편한 점을 개선 및 추가 (메모, 학교별 학사일정 확인 및 추가, 급식정보 통합, 코로나현황)',
      alt: 'homebrowser',
    ...
    {
      name: 'YourTube',
      message: 'Youtube의 주요 기능인 인기동영상, 동영상 검색 및 재생 스크롤을 이용한 페이지로드 기능',
      alt: 'yourtube',
